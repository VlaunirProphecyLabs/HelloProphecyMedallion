...
db_pipeline_id_to_path_dict = {
    "pipelines/raw_bronze_subgraph": "dbfs:/FileStore/prophecy/artifacts/saas/app/__PROJECT_ID_PLACEHOLDER__/__PROJECT_RELEASE_VERSION_PLACEHOLDER__/pipeline/raw_bronze_subgraph-1.0-py3-none-any.whl", 
    ...
    "pipelines/customer_orders": "dbfs:/FileStore/prophecy/artifacts/saas/app/__PROJECT_ID_PLACEHOLDER__/__PROJECT_RELEASE_VERSION_PLACEHOLDER__/pipeline/gold_customer_orders-1.0-py3-none-any.whl", 
...
pipeline_package_name = {
    ...
    "pipelines/raw_bronze_subgraph": "raw_bronze_subgraph", 
    "pipelines/gold_sales": "gold_sales", 
    "pipelines/customer_orders": "gold_customer_orders", 
